...
import { PrismaRouletteSpinEligibilityRepository } from "../../../loyalty/games/infrastructure/PrismaRouletteSpinEligibilityRepository";
import { PrismaRouletteParticipationRepository } from "../../../loyalty/games/infrastructure/PrismaRouletteParticipationRepository";
import { PrismaRouletteSpinUnitOfWork } from "../../../loyalty/games/infrastructure/PrismaRouletteSpinUnitOfWork";
...
import { ApplyCustomerLoyaltyOutcome } from "../../../loyalty/customers/application/loyalty/ApplyCustomerLoyaltyOutcome";
...
builder.registerAndUse(PrismaRouletteSpinEligibilityRepository);
builder.register(RouletteParticipationRepository).use(PrismaRouletteParticipationRepository);
builder.registerAndUse(PrismaRouletteParticipationRepository);
builder.registerAndUse(IssueRouletteSpinEligibility);
builder.registerAndUse(ResolveRouletteParticipationUsage);
