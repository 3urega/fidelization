...
- **Phase J visual assets:** [`docs/domain/visual-assets-system.md`](docs/domain/visual-assets-system.md) — sellos SVG dinámicos, `LoyaltyProgress`, fondos campaña (`fondos.png`); `verify:loyalty-visual-assets`; issues #50–#54.
