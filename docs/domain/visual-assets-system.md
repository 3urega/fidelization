...
Exposed in owner CRUD APIs and customer `stampProgress[]` payloads as `visualTemplate`.
...
3. **Live preview** — `LoyaltyProgress` with sample `current` slider or fixed demo (e.g. 3/10)
...
| [#51](https://github.com/3urega/fidelization/issues/51) | **J3** | LoyaltyProgress component |
| [#52](https://github.com/3urega/fidelization/issues/52) | **J4** | Stamp campaign visualTemplate API |
| [#53](https://github.com/3urega/fidelization/issues/53) | **J5** | Owner template picker + card preview |
| [#54](https://github.com/3urega/fidelization/issues/54) | **J6** | Customer LoyaltyCard visual stamps |

Manifest: [`manifest.phase-j-loyalty-visual.json`](../issues/manifest.phase-j-loyalty-visual.json)
