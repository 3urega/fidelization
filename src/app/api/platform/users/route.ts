...
import { ListPlatformAppUsers } from "../../../../contexts/platform/application/users/ListPlatformAppUsers";
import { container } from "../../../../contexts/shared/infrastructure/dependency-injection/diod.config";
import { requirePlatformSession } from "../../../../lib/auth/requirePlatformSession";
import { platformAppUsersPageToJson } from "../../../../lib/platform/appUsers";
...
export async function GET(request: Request): Promise<Response> {
	...
	const result = await container.get(ListPlatformAppUsers).execute({
	...
	return NextResponse.json(platformAppUsersPageToJson(result));
}
