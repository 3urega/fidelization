...
**Status:** **In progress** — V1 implemented ([#108](https://github.com/3urega/fidelization/issues/108), 2026-06-20); V2–V7 open ([#109](https://github.com/3urega/fidelization/issues/109)–[#114](https://github.com/3urega/fidelization/issues/114)).
...
| [#109](https://github.com/3urega/fidelization/issues/109) | Phase V2: Roulette persistence (Prisma + tenant activation) | `docs/issues/roulette-persistence-config.md` |
